...
void loop(){
  ...
  motorSpeed = map(targetDistance, 0, 1023, 300, 0); //map the value from the potentiometer to 300 - 0 milliseconds (25 is the fastest usually, but you might be able to get faster)
